<?php
		...
		$query="SELECT id_meat, name_meat, img_m FROM meat_dish";
...
?>  
  <tr>
	...
	<td align="center"><? echo $name_meat; ?> <br>
		
		<center><img src="<? echo $path.$img_m; ?>" width="250" height="200" border="0" ></center>
	
	</td>
	
	<td align="center"><a href="meatDetail.php?id_meat=<?=$row['id_meat']?>" class="btn" rel="tooltip">รายละเอียด</a></td>
