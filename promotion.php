<?php
		...
		$query="SELECT id_pro, name_pro, img_p FROM promotion";
...
?>  
  <tr>
	...
	<td align="center"><? echo $name_pro; ?>
		<center><img src="<? echo $path.$img_p; ?>" width="250" height="200" border="0" ></center>
	</td>
	<td align="center"><a href="promotionDetail.php?id_pro=<?=$row['id_pro']?>" class="btn" rel="tooltip">รายละเอียด</a></td>
