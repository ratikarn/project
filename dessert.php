<?php
		...
		$query="SELECT id_dessert, name_dessert, img_d FROM dessert";
...
?>  
  <tr>
	...
	<td align="center"><? echo $name_dessert; ?>
		<center><img src="<? echo $path.$img_d; ?>" width="250" height="200" border="0" ></center>
	
	</td>
	<td align="center"><a href="dessertDetail.php?id_dessert=<?=$row['id_dessert']?>" class="btn" rel="tooltip">รายละเอียด</a></td>
